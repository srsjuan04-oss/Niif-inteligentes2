...
function Hero({ progress, onCta }) {
  ...
  // Ping-pong loop — most browsers ignore negative playbackRate,
  // so we manually scrub currentTime backwards via rAF on the reverse pass.
  useEffect(() => {
    ...
    const tick = (now) => {
      ...
      last = now;
      if (direction === -1 && !v.paused) {





        // shouldn't happen — we pause on reverse
      }if (direction === -1) {v.currentTime = Math.max(0, v.currentTime - dt);if (v.currentTime <= 0.02) {direction = 1;v.currentTime = 0;
          v.play().catch(() => {});
        } else {
  ...
  return (
    <header className="hero" id="top">
      ...
      <div className="hero-content" ref={contentRef}>
        ...
        <p className="sub">
          Un programa intensivo para contadores y firmas que convierte la norma en decisiones —
          guiado por un copiloto entrenado en estándares internacionales y casos reales.
        </p>
      ...
      <div className="hero-wave-foot">
        <SoundWave count={41} height={60} />
      </div>
    </header>);
    ...
    <section className="problema" id="problema">
      ...
      <div className="problema-inner">
        ...
        <p className="lead reveal">
          La norma cambia, los criterios se mezclan y los detalles se escapan. La diferencia entre
          un cierre limpio y un dictamen difícil casi nunca está en lo que sabes — está en lo que
          recuerdas en el momento exacto.
        </p>
    ...
    <section className="solucion" id="programa">
      <div className="container">
        <div className="head reveal">
          ...
          <p className="lead">
            NIIF Inteligente combina formación intensiva con un copiloto persistente. Cuando el
            curso termina, el asistente sigue contigo — todos los días, en cada cliente.
          </p>
        </div>
...
function Incluye() {
  ...
  { t: "Biblioteca de plantillas", d: "Cuatro sesiones de cuatro horas con resolución de casos en tiempo real." },
  { t: "Casos resueltos", d: "Cuatro sesiones de cuatro horas con resolución de casos en tiempo real." },
  { t: "16 horas en vivo", d: "Cuatro sesiones de cuatro horas con resolución de casos en tiempo real." },
    ...
    <section className="pricing" id="precio">
      ...
      <div className="container pricing-inner">
        ...
        <div className="price-card reveal">
          ...
          <h3>NIIF Inteligente · Cohorte 07</h3>
          <div className="row">
...
function App() {
  ...
  return (
    <>
      <Navbar onCta={scrollToPrice} />
      <Hero progress={progress} onCta={scrollToPrice} />
      <Problema />
      <Solucion />
      <Incluye />
      <Trust />
      <Testimonios />
      <Pricing onCta={scrollToPrice} />
      <Footer />
      <button
